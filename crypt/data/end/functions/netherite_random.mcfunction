execute in minecraft:the_end run summon wither 13 173 13 {PersistenceRequired:1b,Health:40f,CustomName:'{"text":"NETHERITE PROTECTOR","color":"dark_purple","bold":true}',Attributes:[{Name:generic.max_health,Base:40}]}
execute in minecraft:the_end run summon wither -13 173 -13 {PersistenceRequired:1b,Health:40f,CustomName:'{"text":"NETHERITE PROTECTOR","color":"dark_purple","bold":true}',Attributes:[{Name:generic.max_health,Base:40}]}
execute in minecraft:the_end run particle minecraft:spit 13 175 13 0 0 0 0.2 50
execute in minecraft:the_end run particle minecraft:spit -13 175 -13 0 0 0 0.2 50
