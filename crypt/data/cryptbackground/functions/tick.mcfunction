...
#diamond staff
execute as @a[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{CustomModelData:4653}}},scores={rightclick=1..,cooldown=0}] at @s run function cryptbackground:diamond_staff
...
execute as @a[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{CustomModelData:665566}}},scores={rightclick=1..,cooldown=0}] at @s run function cryptbackground:snap
execute as @a[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick"}},scores={rightclick=1..,cooldown=1..}] at @s run function cryptbackground:cooldown
...
execute as @a[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{CustomModelData:48894}}},scores={rightclick=1..,cooldown=0}] at @s run function cryptbackground:steel_weight
execute as @a[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{CustomModelData:133542}}},scores={rightclick=1..,cooldown=0},gamemode=!adventure] at @s run function cryptbackground:banhammerfire
