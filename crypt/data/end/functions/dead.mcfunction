...
execute in minecraft:the_end if score golddrag end_crypt matches 1 run function end:gold_dead
execute in minecraft:the_end if score golddrag end_crypt matches 1 run tellraw @a[tag=debug] [{"text": "[","color": "gold","bold":true},{"text": "DEBUG","color": "red"},{"text": "]","color": "gold","bold":true},{"text": " Line 5 From function dead ran command gold_dead decided that it was gold dragon","color": "green"}]
execute in minecraft:the_end if score diamonddrag end_crypt matches 1 run function end:diamond_dead
execute in minecraft:the_end if score diamonddrag end_crypt matches 1 run tellraw @a[tag=debug] [{"text": "[","color": "gold","bold":true},{"text": "DEBUG","color": "red"},{"text": "]","color": "gold","bold":true},{"text": " Line 3 From function dead ran command iron_dead decided that it was iron dragon","color": "green"}]
execute in minecraft:the_end if score netheritedrag end_crypt matches 1 run function end:netherite_dead
execute in minecraft:the_end if score netheritedrag end_crypt matches 1 run tellraw @a[tag=debug] [{"text": "[","color": "gold","bold":true},{"text": "DEBUG","color": "red"},{"text": "]","color": "gold","bold":true},{"text": " Line 5 From function dead ran command gold_dead decided that it was gold dragon","color": "green"}]
...
kill @e[tag=crypt]
execute in minecraft:the_end run setblock 1 171 1 minecraft:end_stone_brick_wall
execute in minecraft:the_end run setblock -1 171 1 minecraft:end_stone_brick_wall
execute in minecraft:the_end run setblock 1 171 -1 minecraft:end_stone_brick_wall
execute in minecraft:the_end run setblock -1 171 -1 minecraft:end_stone_brick_wall