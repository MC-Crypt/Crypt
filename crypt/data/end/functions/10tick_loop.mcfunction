...
execute in end:crypt run kill @e[x=-64,y=100,z=-64,dx=128,dy=48,dz=128]
execute if score netheritedrag end_crypt matches 1 if score netheritepearch end_crypt matches 1 in end:crypt run tp @e[type=ender_dragon,limit=1,tag=crypt] 0 70 0
