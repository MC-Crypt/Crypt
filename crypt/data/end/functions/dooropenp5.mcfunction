execute in end:crypt run fill 1 169 -63 1 162 -63 air replace minecraft:bedrock
execute in end:crypt run fill -1 169 -63 -1 162 -63 air replace minecraft:bedrock
execute in end:crypt run fill 2 169 -63 2 162 -63 bedrock replace minecraft:air
execute in end:crypt run fill -2 169 -63 -2 162 -63 bedrock replace minecraft:air
