execute in minecraft:the_end run fill 2 162 -63 2 169 -63 air replace minecraft:bedrock
execute in minecraft:the_end run fill -2 162 -63 -2 169 -63 air replace minecraft:bedrock
execute in minecraft:the_end run fill 1 169 -63 1 162 -63 bedrock replace minecraft:air
execute in minecraft:the_end run fill -1 169 -63 -1 162 -63 bedrock replace minecraft:air
